import { ClearableObjectPool, Logger, ShaderPass, RenderStateDataKey, RenderQueueType, CompareFunction, StencilOperation, BlendOperation, BlendFactor, CullMode, Color, ShaderLib, ShaderPlatformTarget } from '@galacean/engine';
...
var ShaderLabUtils = /*#__PURE__*/ function() {
    ...
    ShaderLabUtils.createObjectPool = function createObjectPool(type) {
        var pool = new ClearableObjectPool(type);
    ...
    _proto.set = function set(type, lexeme, arg) {
        ...
        if (arg) {
            if (_instanceof(arg, ShaderRange)) {
                ...
                var end = ShaderLab.createPosition(arg.index + lexeme.length);
...
var BaseScanner = /*#__PURE__*/ function() {
    ...
    _proto.getCurPosition = function getCurPosition() {
        return ShaderLab.createPosition(this._currentIndex);
    };
 ...
 */ var Lexer = /*#__PURE__*/ function(BaseScanner) {
    ...
    _proto._getPosition = function _getPosition(offset /** offset from starting point */ ) {
        ...
        return ShaderLab.createPosition(this.current - offset);
    };
...
]), GrammarUtils.createProductionWithOptions(ENonTerminal.interpolation_qualifier, [
    [
        EKeyword.SMOOTH
    ],
    [
...
]), GrammarUtils.createProductionWithOptions(ENonTerminal.invariant_qualifier, [
    [
        EKeyword.INVARIANT
    ]
]), GrammarUtils.createProductionWithOptions(ENonTerminal.precision_qualifier, [
    [
        EKeyword.HIGHP
    ],
    [
...
]), GrammarUtils.createProductionWithOptions(ENonTerminal.logical_or_expression, [
    [
...
]), GrammarUtils.createProductionWithOptions(ENonTerminal.logical_xor_expression, [
    [
...
]), GrammarUtils.createProductionWithOptions(ENonTerminal.logical_and_expression, [
    [
...
]), GrammarUtils.createProductionWithOptions(ENonTerminal.inclusive_or_expression, [
    [
...
]), GrammarUtils.createProductionWithOptions(ENonTerminal.exclusive_or_expression, [
    [
...
]), GrammarUtils.createProductionWithOptions(ENonTerminal.equality_expression, [
    [
...
]), GrammarUtils.createProductionWithOptions(ENonTerminal.relational_expression, [
    [
...
]), GrammarUtils.createProductionWithOptions(ENonTerminal.additive_expression, [
    [
...
]), GrammarUtils.createProductionWithOptions(ENonTerminal.multiplicative_expression, [
    [
...
]), GrammarUtils.createProductionWithOptions(ENonTerminal.function_call, [
    [
...
]), GrammarUtils.createProductionWithOptions(ENonTerminal.compound_statement_no_scope, [
    [
        ETokenType.LEFT_BRACE,
        ETokenType.RIGHT_BRACE
    ],
...
]), GrammarUtils.createProductionWithOptions(ENonTerminal.expression_statement, [
    [
        ETokenType.SEMICOLON
    ],
    [
...
]), GrammarUtils.createProductionWithOptions(ENonTerminal.selection_statement, [
    [
        EKeyword.IF,
        ETokenType.LEFT_PAREN,
        ENonTerminal.expression,
...
]), GrammarUtils.createProductionWithOptions(ENonTerminal.iteration_statement, [
    [
        EKeyword.WHILE,
        ETokenType.LEFT_PAREN,
...
]), GrammarUtils.createProductionWithOptions(ENonTerminal.precision_specifier, [
    [
        EKeyword.PRECISION,
        ENonTerminal.precision_qualifier,
        ENonTerminal.ext_builtin_type_specifier_nonarray,
    ...
    _proto.parse = function parse(tokens) {
        ...
        while(true){
            ...
            if ((actionInfo == null ? void 0 : actionInfo.action) === EAction.Shift) {
                ...
                Logger.info("[pass compilation - parser] Accept! State automata run " + loopCount + " times! cost time " + (performance.now() - start) + "ms");
...
var PpScanner = /*#__PURE__*/ function(BaseScanner) {
    ...
    function PpScanner(source) {
        var _this;
        _this = BaseScanner.call(this, source) || this, _this.macroLvl = 0;
        return _this;
    }
   ...
   */ _proto.scanWordsUntilChar = function scanWordsUntilChar(nonLetterChar) {
    ...
    _proto.getShaderPosition = function getShaderPosition(offset /** offset from starting point */ ) {
        if (offset === void 0) offset = 0;
        return ShaderLab.createPosition(this._currentIndex - offset);
    };
    /**
...
/** @internal */ var VisitorContext = /*#__PURE__*/ function() {
    ...
    _proto.referenceAttribute = function referenceAttribute(ident) {
        ...
        if (!prop) {
            return ShaderLabUtils.createGSError("referenced attribute not found: " + ident.lexeme, GSErrorName$1.CompilationError, ShaderLab._processingPassText, ident.location);
        }
    ...
    _proto.referenceVarying = function referenceVarying(ident) {
        ...
        if (!prop) {
            return ShaderLabUtils.createGSError("referenced varying not found: " + ident.lexeme, GSErrorName$1.CompilationError, ShaderLab._processingPassText, ident.location);
        }
 ...
 */ var ShaderContentParser = /*#__PURE__*/ function() {
    ...
    ShaderContentParser._parseRenderStateDeclarationOrAssignment = function _parseRenderStateDeclarationOrAssignment(ret, stateToken, scanner) {
        ...
        if (ident.type === ETokenType.ID) {
            ...
            if (!(sm == null ? void 0 : sm.value)) {
                ShaderLabUtils.createGSError('Invalid "' + stateToken.lexeme + '" variable: ' + variable.lexeme, GSErrorName$1.CompilationError, scanner.source, variable.location);
            }
    ...
    ShaderContentParser._parseRenderStatePropItem = function _parseRenderStatePropItem(ret, state, scanner) {
        ...
        if (state === "BlendState" && renderStateProp !== "BlendColor" && renderStateProp !== "AlphaToCoverage") {
            ...
            if (op.lexeme === "[") {
                ...
                ShaderLabUtils.createGSError("Invalid syntax, expect character '=', but got " + op.lexeme, GSErrorName$1.CompilationError, scanner.source, scanner.getCurPosition());
            }
            renderStateProp += idx;
        }
        renderStateProp = state + renderStateProp;
        var renderStateElementKey = RenderStateDataKey[renderStateProp];
        if (renderStateElementKey == undefined) {
            ShaderLabUtils.createGSError("Invalid render state element " + renderStateProp, GSErrorName$1.CompilationError, scanner.source, scanner.getCurPosition());
        }
        scanner.skipCommentsAndSpace();
        var value;
        if (/[0-9.]/.test(scanner.getCurChar())) {
            ...
            if (token.type === EKeyword.TRUE) value = true;
                ...
                value = _construct(Color, [].concat(args));
            } else if (scanner.getCurChar() === ".") {
                ...
                if (value == undefined) {
                    ShaderLabUtils.createGSError("Invalid engine constant: " + token.lexeme + "." + engineTypeProp.lexeme, GSErrorName$1.CompilationError, scanner.source, engineTypeProp.location);
                }
            } else {
                value = token.lexeme;
            }
    ...
    ShaderContentParser._parseRenderQueueAssignment = function _parseRenderQueueAssignment(ret, scanner) {
        ...
        var key = RenderStateDataKey.RenderQueueType;
        if (value == undefined) {
        ...
        while(true){
            ...
            switch(word.type){
                ...
                case EKeyword.GS_FragmentShader:
                    ...
                    if (ret[word.lexeme]) {
                        ShaderLabUtils.createGSError("reassign main entry", GSErrorName$1.CompilationError, scanner.source, scanner.getCurPosition());
                    }
...
/** @internal */ var ShaderLab = /*#__PURE__*/ function() {
    ...
    _proto._parseShaderPass = function _parseShaderPass(source, vertexEntry, fragmentEntry, macros, backend, platformMacros, basePathForIncludeKey) {
        ...
        var codeGen = backend === ShaderPlatformTarget.GLES100 ? GLES100Visitor.getVisitor() : GLES300Visitor.getVisitor();
        var start = performance.now();
