import { Shader, ModelMesh, Matrix, Quaternion, Vector3, MeshRenderer, PrimitiveMesh, Color, Material, RenderQueueType, SkinnedMeshRenderer, Script } from '@galacean/engine';
 ...
 */ var SkeletonViewer = /*#__PURE__*/ function(Script) {
    ...
    function SkeletonViewer(entity) {
        ...
        /** The min color.  */ _this.colorMin = new Color(0.35, 0.35, 0.35, 1);
        /** The max color. */ _this.colorMax = new Color(0.7, 0.7, 0.7, 1);
        _this._debugMesh = [];
        var engine = entity.engine;
        if (!materialMap.get(engine)) {
            var material = new Material(entity.engine, Shader.find("skeleton-viewer"));
        ...
        _this.entity.getComponentsIncludeChildren(SkinnedMeshRenderer, skinnedMeshRenderers);
    ...
    _proto._createSpur = function _createSpur(direction) {
        var mesh = new ModelMesh(this.engine);
    ...
    _proto._showSkeleton = function _showSkeleton(renderer) {
        ...
        for(var i = 0; i < bones.length; i++){
            ...
            var _$renderer = entity.addComponent(MeshRenderer);
            _$renderer.receiveShadows = false;
            _$renderer.castShadows = false;
            _$renderer.mesh = PrimitiveMesh.createSphere(this.engine, this.ballSize, 16);
            ...
            for(var j = 0; j < bone.children.length; j++){
                ...
                var entity1 = bone;
                var _$renderer1 = entity1.addComponent(MeshRenderer);
