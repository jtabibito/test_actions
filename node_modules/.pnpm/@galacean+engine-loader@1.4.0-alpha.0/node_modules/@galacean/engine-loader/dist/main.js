            ...
            var promise = GLTFUtils.getAccessorBuffer(context, gltf.bufferViews, accessor).then(function(accessorBuffer) {
                ...
                if (accessorBuffer.interleaved) {
                    ...
                    if (vertexBindingInfos[meshId] === undefined) {
                        ...
                        if (!vertexBuffer) {
                            vertexBuffer = new engineCore.Buffer(engine, engineCore.BufferBindFlag.VertexBuffer, vertices, engineCore.BufferUsage.Static, keepMeshData);
                    ...
                    if (!vertexBuffer1) {
                        vertexBuffer1 = new engineCore.Buffer(engine, engineCore.BufferBindFlag.VertexBuffer, vertices, engineCore.BufferUsage.Static, keepMeshData);
...
function getEngineFormat(internalFormat) {
    switch(internalFormat){
        ...
        case engineRhiWebgl.GLCompressedTextureInternalFormat.RGB_S3TC_DXT1_EXT:
            return engineCore.TextureFormat.BC1;
        case engineRhiWebgl.GLCompressedTextureInternalFormat.RGBA_S3TC_DXT5_EXT:
            return engineCore.TextureFormat.BC3;
        case engineRhiWebgl.GLCompressedTextureInternalFormat.RGBA_BPTC_UNORM_EXT:
            return engineCore.TextureFormat.BC7;
