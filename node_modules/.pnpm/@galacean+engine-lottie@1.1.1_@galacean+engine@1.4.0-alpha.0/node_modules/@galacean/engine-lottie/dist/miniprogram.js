...
var CompLottieElement = /*#__PURE__*/ function(BaseLottieElement) {
    ...
    function CompLottieElement(layer, engine, entity, name) {
        var _this;
        ...
        if (entity) {
            ...
            var compEntity = new miniprogram.Entity(engine, name);
    ...
    function SpriteLottieElement(layer, atlas, entity, childEntity) {
        ...
        if (layer.refId) {
            if (childEntity) {
                ...
                spriteRenderer = childEntity.getComponent(miniprogram.SpriteRenderer);
                _this.sprite = spriteRenderer.sprite;
            } else {
                _this.sprite = atlas.getSprite(layer.refId);
                var spriteEntity = new miniprogram.Entity(entity.engine, layer.nm);
                spriteRenderer = spriteEntity.addComponent(miniprogram.SpriteRenderer);
            ...
            texture.wrapModeU = texture.wrapModeV = miniprogram.TextureWrapMode.Clamp;
...
var TextLottieElement = /*#__PURE__*/ function(BaseLottieElement) {
    ...
    function TextLottieElement(layer, engine, entity, name) {
        var _this;
        ...
        if (entity) {
            ...
            _this.entity = new miniprogram.Entity(engine, layer.nm);
        }
        var textRenderer = _this.entity.addComponent(miniprogram.TextRenderer);
        ...
        if (keyframes.length === 1) {
            ...
            if (firstKeyframeStart) {
                ...
                textRenderer.font = miniprogram.Font.createFromOS(engine, font);
                ...
                miniprogram.Logger.warn("TextLottieElement: " + name + ", No corresponding text data found.");
            }
        } else {
            // TODO: multi keyframes
            miniprogram.Logger.warn("TextLottieElement: multi keyframes feature is not supported in this version.");
        }
...
var LottieAnimation = /*#__PURE__*/ function(Script) {
    ...
    function LottieAnimation() {
        ...
        _this.pixelsPerUnit = miniprogram.Engine._pixelsPerUnit, _this._alpha = 1, _this._priority = 0, _this._priorityDirty = true, _this._layer = miniprogram.Layer.Layer0, _this._layerDirty = true, _this._autoPlay = false, _this._clipEndCallbacks = {}, _this._isPlaying = false, _this._curFrame = 0, _this._frame = 0, _this._root = null;
        return _this;
    }
   ...
   */ _proto.onUpdate = function onUpdate(deltaTime) {
        ...
        if (this._priorityDirty) {
            ...
            renderers.length = 0;
            this.entity.getComponentsIncludeChildren(miniprogram.Renderer, renderers);
...
LottieAnimation._pivotVector = new miniprogram.Vector2();
...
exports.EditorLottieLoader = /*#__PURE__*/ function(Loader) {
    ...
    _proto.load = function load(item, resourceManager) {
        return new miniprogram.AssetPromise(function(resolve) {
            miniprogram.request(item.url, {
                type: "json"
            }).then(function(data) {
                var jsonUrl = data.jsonUrl, atlasUrl = data.atlasUrl;
                var jsonPromise = miniprogram.request(jsonUrl, resourceManager);
...
exports.EditorLottieLoader = __decorate([
    miniprogram.resourceLoader("EditorLottie", [
        "json"
    ])
], exports.EditorLottieLoader);

var Base64Atlas = /*#__PURE__*/ function() {
    function Base64Atlas(assets, engine) {
        var _this = this;
        this.sprites = {};
        this.assetsPromises = [];
        this.assetsPromises = assets.map(function(asset) {
            return engine.resourceManager.load({
                ...
                var sprite = new miniprogram.Sprite(engine);
...
exports.LottieLoader = /*#__PURE__*/ function(Loader) {
    ...
    _proto.load = function load(item, resourceManager) {
        var urls = item.urls;
        var jsonPromise = miniprogram.request(urls[0], {
            type: "json"
        });
        // atlas
        if (urls[1]) {
            ...
            return miniprogram.AssetPromise.all([
                ...
                var engine = resourceManager.engine;
                var resource = new LottieResource(engine, res, atlas);
                var lottieEntity = new miniprogram.Entity(engine);
...
exports.LottieLoader = __decorate([
    miniprogram.resourceLoader("lottie", [
        "json"
    ])
], exports.LottieLoader);

miniprogram.Loader.registerClass("LottieAnimation", LottieAnimation);
