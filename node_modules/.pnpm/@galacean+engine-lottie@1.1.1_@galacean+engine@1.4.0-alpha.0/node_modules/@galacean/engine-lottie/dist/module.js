import { Entity, SpriteRenderer, TextureWrapMode, TextRenderer, Font, Logger, Vector2, Renderer, ignoreClone, Engine, Layer, Script, EngineObject, resourceLoader, AssetPromise, request, AssetType, Loader, Sprite } from '@galacean/engine';
...
var LottieAnimation = /*#__PURE__*/ function(Script) {
    ...
    function LottieAnimation() {
        ...
        _this.pixelsPerUnit = Engine._pixelsPerUnit, _this._alpha = 1, _this._priority = 0, _this._priorityDirty = true, _this._layer = Layer.Layer0, _this._layerDirty = true, _this._autoPlay = false, _this._clipEndCallbacks = {}, _this._isPlaying = false, _this._curFrame = 0, _this._frame = 0, _this._root = null;
        return _this;
    }
...
var EditorLottieLoader = /*#__PURE__*/ function(Loader) {
    ...
    _proto.load = function load(item, resourceManager) {
        return new AssetPromise(function(resolve) {
            request(item.url, {
                ...
                var jsonPromise = request(jsonUrl, resourceManager);
...
var LottieLoader = /*#__PURE__*/ function(Loader) {
    ...
    _proto.load = function load(item, resourceManager) {
        var urls = item.urls;
        var jsonPromise = request(urls[0], {
            type: "json"
        });
        // atlas
        if (urls[1]) {
...
export { EditorLottieLoader, LottieAnimation, LottieLoader, LottieResource };
