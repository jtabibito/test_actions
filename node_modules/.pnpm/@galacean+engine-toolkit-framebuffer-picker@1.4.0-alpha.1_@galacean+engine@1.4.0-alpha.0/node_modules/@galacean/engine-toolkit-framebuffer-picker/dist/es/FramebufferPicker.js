import { Shader, ShaderProperty, dependentComponents, Camera, DependentMode, RenderTarget, Texture2D, TextureFormat, Renderer, Vector3, DepthTextureMode, Logger, Vector2, Script } from '@galacean/engine';
...
var pickShader = Shader.create("framebuffer-picker-color", vs, fs);
...
var FramebufferPicker = /*#__PURE__*/ function(Script) {
    ...
    function FramebufferPicker() {
        ...
        _this._renderersMap = [];
        _this._frameBufferSize = new Vector2(1024, 1024);
        return _this;
    }
   ...
   */ _proto.regionPick = function regionPick(startX, startY, endX, endY) {
    ...
    _proto._checkFrameBufferSize = function _checkFrameBufferSize() {
        ...
        if (!pickRenderTarget || size.x != pickRenderTarget.width || size.y != pickRenderTarget.height) {
            ...
            this._pickRenderTarget = new RenderTarget(engine, size.x, size.y, new Texture2D(engine, size.x, size.y, TextureFormat.R8G8B8A8, false));
        }
    };
...
FramebufferPicker._pickColorProperty = ShaderProperty.getByName("u_pickColor");
FramebufferPicker = __decorate([
    dependentComponents(Camera, DependentMode.CheckOnly)
], FramebufferPicker);

export { FramebufferPicker };
//# sourceMappingURL=FramebufferPicker.js.map
