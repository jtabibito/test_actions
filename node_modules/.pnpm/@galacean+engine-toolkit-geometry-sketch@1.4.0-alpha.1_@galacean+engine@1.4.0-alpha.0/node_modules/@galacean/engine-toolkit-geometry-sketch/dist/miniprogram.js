 ...
 */ var NormalMaterial = /*#__PURE__*/ function(BaseMaterial) {
    ...
    function NormalMaterial(engine) {
        var _this;
        _this = BaseMaterial.call(this, engine, miniprogram.Shader.find("tbnShader")) || this;
        _this.shaderData.setColor(NormalMaterial._baseColorProp, new miniprogram.Color(1, 0, 0, 1));
 ...
 */ var TangentMaterial = /*#__PURE__*/ function(BaseMaterial) {
    ...
    function TangentMaterial(engine) {
        var _this;
        _this = BaseMaterial.call(this, engine, miniprogram.Shader.find("tbnShader")) || this;
        _this.shaderData.setColor(TangentMaterial._baseColorProp, new miniprogram.Color(0, 1, 0, 1));
 ...
 */ var BiTangentMaterial = /*#__PURE__*/ function(BaseMaterial) {
    ...
    function BiTangentMaterial(engine) {
        var _this;
        _this = BaseMaterial.call(this, engine, miniprogram.Shader.find("tbnShader")) || this;
        _this.shaderData.setColor(BiTangentMaterial._baseColorProp, new miniprogram.Color(0, 0, 1, 1));
...
var WireframeMaterial = /*#__PURE__*/ function(BaseMaterial) {
    ...
    function WireframeMaterial(engine) {
        var _this;
        _this = BaseMaterial.call(this, engine, miniprogram.Shader.find("wireframeShader")) || this;
        _this.shaderData.setColor(WireframeMaterial._baseColorProp, new miniprogram.Color(0, 0, 0, 1));
        _this.isTransparent = true;
        _this.renderFace = miniprogram.RenderFace.Double;
        return _this;
    }
 ...
 */ var SketchRenderer = /*#__PURE__*/ function(SkinnedMeshRenderer) {
    ...
    function SketchRenderer(entity) {
        ...
        _this._worldNormalMatrix = new miniprogram.Matrix();
        ...
        _this._triangleSubMesh = new miniprogram.SubMesh();
        _this._lineSubMesh = new miniprogram.SubMesh(0, 0, miniprogram.MeshTopology.Lines);
        var engine = _this.engine;
        _this.mesh = new miniprogram.ModelMesh(engine);
   ...
   */ _proto.setSketchMode = function setSketchMode(mode, isShow) {
    ...
    _proto.update = function update(deltaTime) {
        ...
        if (worldMatrix) {
            ...
            miniprogram.Matrix.invert(worldMatrix, worldNormalMatrix);
    ...
    _proto._uploadIndicesBuffer = function _uploadIndicesBuffer(value) {
        ...
        var triangleCount = 0;
        switch(indexFormat){
            case miniprogram.IndexFormat.UInt8:
                {
                    ...
                    this._indicesTexture = new miniprogram.Texture2D(this.engine, width, height, miniprogram.TextureFormat.R32G32B32A32, false);
            ...
            case miniprogram.IndexFormat.UInt16:
                {
                    ...
                    this._indicesTexture = new miniprogram.Texture2D(this.engine, width1, height1, miniprogram.TextureFormat.R32G32B32A32, false);
            ...
            case miniprogram.IndexFormat.UInt32:
                {
                    ...
                    this._indicesTexture = new miniprogram.Texture2D(this.engine, width2, height2, miniprogram.TextureFormat.R32G32B32A32, false);
        ...
        this._indicesTexture.filterMode = miniprogram.TextureFilterMode.Point;
    };
    ...
    _proto._createVerticesTexture = function _createVerticesTexture(vertexBuffer, width, height) {
        this._verticesTexture = new miniprogram.Texture2D(this.engine, width, height, miniprogram.TextureFormat.R32G32B32A32, false);
        this._verticesTexture.filterMode = miniprogram.TextureFilterMode.Point;
...
}(miniprogram.SkinnedMeshRenderer);
SketchRenderer._weightMacro = miniprogram.ShaderMacro.getByName("RENDERER_HAS_WEIGHT");
SketchRenderer._jointMacro = miniprogram.ShaderMacro.getByName("RENDERER_HAS_JOINT");
SketchRenderer._MAX_TEXTURE_ROWS = 512;
SketchRenderer._jointIndexBegin = -1;
SketchRenderer._verticesSamplerProp = miniprogram.ShaderProperty.getByName("u_verticesSampler");
SketchRenderer._verticesTextureHeightProp = miniprogram.ShaderProperty.getByName("u_verticesTextureHeight");
SketchRenderer._verticesTextureWidthProp = miniprogram.ShaderProperty.getByName("u_verticesTextureWidth");
SketchRenderer._indicesSamplerProp = miniprogram.ShaderProperty.getByName("u_indicesSampler");
SketchRenderer._indicesTextureHeightProp = miniprogram.ShaderProperty.getByName("u_indicesTextureHeight");
SketchRenderer._indicesTextureWidthProp = miniprogram.ShaderProperty.getByName("u_indicesTextureWidth");
SketchRenderer._lineScaleProp = miniprogram.ShaderProperty.getByName("u_lineScale");
SketchRenderer._worldMatrixProp = miniprogram.ShaderProperty.getByName("u_worldMatrix");
SketchRenderer._worldNormalProp = miniprogram.ShaderProperty.getByName("u_worldNormal");
