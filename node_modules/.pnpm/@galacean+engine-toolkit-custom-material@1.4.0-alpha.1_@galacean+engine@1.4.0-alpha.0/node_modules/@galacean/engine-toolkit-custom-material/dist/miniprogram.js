...
var PlanarShadowShaderFactory = /*#__PURE__*/ function() {
   ...
   */ PlanarShadowShaderFactory.replaceShader = function replaceShader(material) {
        material.shader = miniprogram.Shader.find("planarShadowShader");
        var shadowRenderState = material.renderStates[1];
        shadowRenderState.renderQueueType = miniprogram.RenderQueueType.Transparent;
        shadowRenderState.depthState.writeEnabled = false;
        var targetBlendState = shadowRenderState.blendState.targetBlendState;
        targetBlendState.enabled = true;
        targetBlendState.sourceColorBlendFactor = miniprogram.BlendFactor.SourceAlpha;
        targetBlendState.destinationColorBlendFactor = miniprogram.BlendFactor.OneMinusSourceAlpha;
        targetBlendState.sourceAlphaBlendFactor = miniprogram.BlendFactor.One;
        targetBlendState.destinationAlphaBlendFactor = miniprogram.BlendFactor.OneMinusSourceAlpha;
        // set shadow pass stencilState
        var stencilState = shadowRenderState.stencilState;
        stencilState.enabled = true;
        stencilState.referenceValue = 0;
        stencilState.compareFunctionFront = miniprogram.CompareFunction.Equal;
        stencilState.compareFunctionBack = miniprogram.CompareFunction.Equal;
        stencilState.failOperationFront = miniprogram.StencilOperation.Keep;
        stencilState.failOperationBack = miniprogram.StencilOperation.Keep;
        stencilState.zFailOperationFront = miniprogram.StencilOperation.Keep;
        stencilState.zFailOperationBack = miniprogram.StencilOperation.Keep;
        stencilState.passOperationFront = miniprogram.StencilOperation.IncrementWrap;
        stencilState.passOperationBack = miniprogram.StencilOperation.IncrementWrap;
        var shaderData = material.shaderData;
        shaderData.setFloat(PlanarShadowShaderFactory._shadowFalloffProp, 0);
        shaderData.setColor(PlanarShadowShaderFactory._shadowColorProp, new miniprogram.Color(1.0, 1.0, 1.0, 1.0));
        shaderData.setVector3(PlanarShadowShaderFactory._lightDirProp, new miniprogram.Vector3(0, 0, 0));
...
PlanarShadowShaderFactory._lightDirProp = miniprogram.ShaderProperty.getByName("u_lightDir");
PlanarShadowShaderFactory._planarHeightProp = miniprogram.ShaderProperty.getByName("u_planarHeight");
PlanarShadowShaderFactory._shadowColorProp = miniprogram.ShaderProperty.getByName("u_planarShadowColor");
PlanarShadowShaderFactory._shadowFalloffProp = miniprogram.ShaderProperty.getByName("u_planarShadowFalloff");
 ...
 */ var GridMaterial = /*#__PURE__*/ function(BaseMaterial) {
    ...
    function GridMaterial(engine) {
        var _this;
        _this = BaseMaterial.call(this, engine, miniprogram.Shader.find("grid")) || this;
   ...
   */ function get() {
            ...
            set: function set(value) {
                this.shaderData.setFloat(GridMaterial._flipProgressProperty, miniprogram.MathUtil.clamp(value, 0, 1));
            }
        },
        {
            key: "fade",
   ...
   */ function get() {
            ...
            set: function set(value) {
                this.shaderData.setFloat(GridMaterial._fadeProperty, miniprogram.MathUtil.clamp(value, 0, 1));
            }
        }
    ]);
    return GridMaterial;
}(miniprogram.BaseMaterial);
GridMaterial._farClipProperty = miniprogram.ShaderProperty.getByName("u_far");
GridMaterial._nearClipProperty = miniprogram.ShaderProperty.getByName("u_near");
GridMaterial._primaryScaleProperty = miniprogram.ShaderProperty.getByName("u_primaryScale");
GridMaterial._secondaryScaleProperty = miniprogram.ShaderProperty.getByName("u_secondaryScale");
GridMaterial._gridIntensityProperty = miniprogram.ShaderProperty.getByName("u_gridIntensity");
GridMaterial._axisIntensityProperty = miniprogram.ShaderProperty.getByName("u_axisIntensity");
GridMaterial._flipProgressProperty = miniprogram.ShaderProperty.getByName("u_flipProgress");
GridMaterial._fadeProperty = miniprogram.ShaderProperty.getByName("u_fade");
...
var GridMesh = /*#__PURE__*/ function() {
    ...
    GridMesh._updateGridData = function _updateGridData(mesh) {
        ...
        mesh.setVertexElements([
            new miniprogram.VertexElement("POSITION_FLIP", 0, miniprogram.VertexElementFormat.Vector4, 0)
        ]);
        mesh.setVertexBufferBinding(new miniprogram.Buffer(mesh.engine, miniprogram.BufferBindFlag.VertexBuffer, vertices, miniprogram.BufferUsage.Static), 16);
        mesh.addSubMesh(0, 4, miniprogram.MeshTopology.TriangleStrip);
 ...
 */ var GridControl = /*#__PURE__*/ function(Script) {
   ...
   */ _this.distance = 8;
    ...
    _proto.onAwake = function onAwake() {
        ...
        var gridRenderer = entity.addComponent(miniprogram.MeshRenderer);
    ...
    _proto.onUpdate = function onUpdate(deltaTime) {
        ...
        if (this._flipGrid) {
            ...
            var percent = miniprogram.MathUtil.clamp(this._progress * this.speed, 0, 1);
            if (percent >= 1) {
...
var WaterRippleMaterial = /*#__PURE__*/ function(BaseMaterial) {
    ...
    function WaterRippleMaterial(engine) {
        var _this;
        _this = BaseMaterial.call(this, engine, miniprogram.Shader.find("water-ripple")) || this;
        _this.isTransparent = true;
        var shaderData = _this.shaderData;
        shaderData.setVector3(WaterRippleMaterial._foamColor, new miniprogram.Vector3((69 + 255) / 400, (156 + 255) / 400, (247 + 255) / 400));
        shaderData.setVector2(WaterRippleMaterial._foamSpeed, new miniprogram.Vector2(-1, 0.3));
        shaderData.setVector2(WaterRippleMaterial._foamParam, new miniprogram.Vector2(2.0, 0.05));
        shaderData.setVector2(WaterRippleMaterial._distorsionSpeed, new miniprogram.Vector2(1.0, 0));
...
WaterRippleMaterial._foamColor = miniprogram.ShaderProperty.getByName("u_foamColor");
WaterRippleMaterial._foamSpeed = miniprogram.ShaderProperty.getByName("u_foam_speed");
WaterRippleMaterial._foamParam = miniprogram.ShaderProperty.getByName("u_foam_param");
WaterRippleMaterial._distorsionSpeed = miniprogram.ShaderProperty.getByName("u_distorsion_speed");
WaterRippleMaterial._distorsionAmount = miniprogram.ShaderProperty.getByName("u_distorsion_amount");
WaterRippleMaterial._foamTextureProp = miniprogram.ShaderProperty.getByName("u_foamTex");
...
var WaterMaterial = /*#__PURE__*/ function(BaseMaterial) {
    ...
    function WaterMaterial(engine) {
        var _this;
        _this = BaseMaterial.call(this, engine, miniprogram.Shader.find("water")) || this;
        _this.shaderData.setVector2(WaterMaterial._waterSpeed, new miniprogram.Vector2(-0.02, 0.02));
        _this.shaderData.setVector4(WaterMaterial._edgeColor, new miniprogram.Vector4((69 + 255) / 510, (156 + 255) / 510, (247 + 255) / 510, 1));
        _this.shaderData.setVector2(WaterMaterial._edgeParam, new miniprogram.Vector2(0.008, 0.002));
        _this.shaderData.setFloat(WaterMaterial._distorsionAmount, 0.02);
        _this.shaderData.setVector2(WaterMaterial._distorsionSpeed, new miniprogram.Vector2(0.2, 0.2));
        return _this;
    }
...
WaterMaterial._waterSpeed = miniprogram.ShaderProperty.getByName("u_water_speed");
WaterMaterial._edgeColor = miniprogram.ShaderProperty.getByName("u_edgeColor");
WaterMaterial._edgeParam = miniprogram.ShaderProperty.getByName("u_edgeParam");
WaterMaterial._distorsionAmount = miniprogram.ShaderProperty.getByName("u_distorsion_amount");
WaterMaterial._distorsionSpeed = miniprogram.ShaderProperty.getByName("u_distorsion_speed");
WaterMaterial._waterTextureProp = miniprogram.ShaderProperty.getByName("u_waterTex");
WaterMaterial._edgeTextureProp = miniprogram.ShaderProperty.getByName("u_edgeTex");
...
var WaterFallMaterial = /*#__PURE__*/ function(BaseMaterial) {
    ...
    function WaterFallMaterial(engine) {
        var _this;
        _this = BaseMaterial.call(this, engine, miniprogram.Shader.find("water-fall")) || this;
        _this.shaderData.setVector2(WaterFallMaterial._waterSpeed, new miniprogram.Vector2(0.2, 0.0));
        _this.shaderData.setVector2(WaterFallMaterial._waterfallSpeed, new miniprogram.Vector2(0.9, 0));
        _this.shaderData.setVector4(WaterFallMaterial._edgeColor, new miniprogram.Vector4(160 / 255, 250 / 255, 250 / 255, 1.0));
        _this.shaderData.setVector2(WaterFallMaterial._edgeParam, new miniprogram.Vector2(0.7, 0.05));
        _this.shaderData.setFloat(WaterFallMaterial._distorsionAmount, 0.03);
        _this.shaderData.setVector2(WaterFallMaterial._distorsionSpeed, new miniprogram.Vector2(1.0, 1.0));
        return _this;
    }
...
WaterFallMaterial._waterSpeed = miniprogram.ShaderProperty.getByName("u_water_speed");
WaterFallMaterial._waterfallSpeed = miniprogram.ShaderProperty.getByName("u_waterfall_speed");
WaterFallMaterial._distorsionSpeed = miniprogram.ShaderProperty.getByName("u_distorsion_speed");
WaterFallMaterial._edgeColor = miniprogram.ShaderProperty.getByName("u_edgeColor");
WaterFallMaterial._edgeParam = miniprogram.ShaderProperty.getByName("u_edgeParam");
WaterFallMaterial._distorsionAmount = miniprogram.ShaderProperty.getByName("u_distorsion_amount");
WaterFallMaterial._waterTextureProp = miniprogram.ShaderProperty.getByName("u_waterTex");
WaterFallMaterial._waterfallTextureProp = miniprogram.ShaderProperty.getByName("u_waterfallTex");
WaterFallMaterial._edgeTextureProp = miniprogram.ShaderProperty.getByName("u_edgeNoiseTex");
 ...
 */ var BakePBRMaterial = /*#__PURE__*/ function(PBRMaterial) {
    ...
    function BakePBRMaterial(engine) {
        var _this;
        _this = PBRMaterial.call(this, engine) || this;
        _this.shader = miniprogram.Shader.find("bake-pbr");
...
}(miniprogram.PBRMaterial);
BakePBRMaterial._lightMapTextureProp = miniprogram.ShaderProperty.getByName("u_lightMapTexture");
BakePBRMaterial._lightMapIntensityProp = miniprogram.ShaderProperty.getByName("u_lightMapIntensity");
