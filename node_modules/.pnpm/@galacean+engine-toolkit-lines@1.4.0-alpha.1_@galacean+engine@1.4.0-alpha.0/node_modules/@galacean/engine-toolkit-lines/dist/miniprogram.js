...
miniprogram.Shader.create("line", vertexSource$1, fragmentSource$1);

var LineMaterial = /*#__PURE__*/ function(Material) {
    _inherits(LineMaterial, Material);
    function LineMaterial(engine) {
        var _this;
        _this = Material.call(this, engine, miniprogram.Shader.find("line")) || this;
        ...
        rasterState.cullMode = miniprogram.CullMode.Off;
        depthState.writeEnabled = false;
        _this.renderState.renderQueueType = miniprogram.RenderQueueType.Transparent;
        ...
        targetBlendState.sourceAlphaBlendFactor = miniprogram.BlendFactor.SourceAlpha;
        targetBlendState.destinationAlphaBlendFactor = miniprogram.BlendFactor.OneMinusSourceAlpha;
        targetBlendState.colorBlendOperation = miniprogram.BlendOperation.Add;
        targetBlendState.alphaBlendOperation = miniprogram.BlendOperation.Add;
        return _this;
    }
    return LineMaterial;
...
miniprogram.Shader.create("dash", vertexSource, fragmentSource);

var DashMaterial = /*#__PURE__*/ function(LineMaterial) {
    _inherits(DashMaterial, LineMaterial);
    function DashMaterial(engine) {
        var _this;
        _this = LineMaterial.call(this, engine) || this;
        _this.shader = miniprogram.Shader.find("dash");
        return _this;
    }
    return DashMaterial;
}(LineMaterial);
...
var LineVertexBuilder = /*#__PURE__*/ function() {
    function LineVertexBuilder() {
        var _this = this;
        var wasmBuffer = Uint8Array.from(typeof engineMiniprogramAdapter.atob === "undefined" ? atob(wasmString) : engineMiniprogramAdapter.atob(wasmString), function(c) {
 ...
 */ var Line = /*#__PURE__*/ function(Script) {
    ...
    function Line(entity) {
        ...
        _this._width = 0.1;
        _this._color = new miniprogram.Color(0, 0, 0, 1);
   ...
   */ _proto.onAwake = function onAwake() {
        this._renderer = this.entity.addComponent(miniprogram.MeshRenderer);
        this.color = this._color;
        this.join = this._join;
        this.cap = this._cap;
        this.width = this._width;
        this._initMaterial();
        this._mesh = new miniprogram.BufferMesh(this.engine, "LineGeometry");
        // Add vertexElement
        this._mesh.setVertexElements([
            new miniprogram.VertexElement("a_pos", 0, miniprogram.VertexElementFormat.Vector2, 0),
            new miniprogram.VertexElement("a_normal", 8, miniprogram.VertexElementFormat.Vector2, 0),
            new miniprogram.VertexElement("a_data", 16, miniprogram.VertexElementFormat.Short2, 0),
            new miniprogram.VertexElement("a_lengthsofar", 20, miniprogram.VertexElementFormat.Float, 0)
        ]);
            ...
            return __generator(this, function(_state) {
                switch(_state.label){
                    ...
                    case 1:
                        ...
                        vertexBuffer = new miniprogram.Buffer(_this.engine, miniprogram.BufferBindFlag.VertexBuffer, vertices, miniprogram.BufferUsage.Static);
                        indexBuffer = new miniprogram.Buffer(_this.engine, miniprogram.BufferBindFlag.IndexBuffer, indices, miniprogram.BufferUsage.Static);
                        ...
                        _this._mesh.setIndexBufferBinding(indexBuffer, miniprogram.IndexFormat.UInt16);
 ...
 */ var DashLine = /*#__PURE__*/ function(Line) {
   ...
   */ function get() {
            ...
            set: function set(val) {
                ...
                var texture = new miniprogram.Texture2D(this.engine, 1, Math.ceil((val.x + val.y) * 10));
